    ...
    app.get("/api/seedDatabase/questions", function (req, res) {
        ...
        var startQuestions = [
            ...
            },
            {
                ...
                photos: ["images/question7_0.png", "images/question7_1.jpg"],
                options: [
                    {
                        answer: "Buzzer = 17.",
                        correct: true,
